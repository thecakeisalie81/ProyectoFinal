...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE proveedor SET nombre='$supplier_name', contacto='$supplier_contact', direccion='$supplier_address', telefono='$supplier_phone' WHERE id_proveedor='$eid'";
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        echo "<script>document.location='../views/Suppliers.php';</script>";
    } else {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-offset-2">
                        <a href="../views/Suppliers.php" style="font-size: 24px; text-decoration:none; color:black;">
                        ...
                        <div>
                            <form class="row g-3" method="POST" id="categoryForm">
                                <?php
                            $eid = isset($_GET['editid']) ? $_GET['editid'] : '';
                            $sql = mysqli_query($conn, "SELECT * FROM proveedor WHERE id_proveedor='$eid'");
                            if (!$sql) {
                            ...
                            ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="direccion" id="supplier_direction" class="form-control"
                                        required="" placeholder=""
                                        style="height: 100px"><?php echo $row['direccion'];?></textarea>
                                </div>
