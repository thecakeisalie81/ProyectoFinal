...
if(isset($_GET['delid'])){
    ...
    if ($result) {
        $successDelete=true;
        $successDeleteMessage="Categoria eliminada de forma satisfactoria!";
    } else {
...
<section class="dashboard">
    ...
    <div class="content-wrapper">
                ...
                <div class="col-lg-12 col-offset-2">
                    <div class="page-header">
                        <h2 class="mt-3 mt-md-0">
                            <ion-icon name="grid" style="font-size:1.5em;"></ion-icon> Categorias
                        </h2>
                    </div>
                    ...
                    <div>
                        <div class="row">
                            ...
                            $result_count=mysqli_query($conn,"SELECT COUNT(*) as total_records FROM categoria");
                            ...
                            $sql=mysqli_query($conn, "SELECT * FROM categoria LIMIT $offset, $total_records_per_page");
                            $count=1;
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <a href="../controllers/editcategory.php?editid=<?php echo htmlentities($row['id_categoria']); ?>"
                                                            class="btn btn-sm text-white"
                                                            style="background-color:#1988F5;">
                                                            <ion-icon name="create-outline"></ion-icon>
                                                        </a>
                                                        <a href="Category.php?delid=<?php echo htmlentities($row['id_categoria']); ?>"
        ...
        echo "<li class='page-item'><a class='page-link' href='?page_no=$total_no_of_pages'>Last &rsaquo; &rsaquo;</a></li>";
                                ...
                                <a href="../controllers/addcategory.php" class="allButton">Agregar categoria</a>
                            </div>
                        </div>
                    </div>
                </div>
